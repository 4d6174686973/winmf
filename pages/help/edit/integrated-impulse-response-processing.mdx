...
<Tabs items={['IR start detect', 'Thr. rel max [dB]', 'Scan band', 'IR end detect', 'Tailcut compensation']}>
  ...
  <Tabs.Tab>**Tailcut compensation** cmpensates the error caused by the finite integration time at the end of the IIR (dropping of IIR close to the noise floor) according to ISO 3382-1, chapter 5.3.3.</Tabs.Tab>
</Tabs>
